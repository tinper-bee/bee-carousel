...
var ReactSwiper = function (_React$Component) {
  ...
  ReactSwiper.prototype.componentDidMount = function componentDidMount() {
    this.swiper = new _swiper2["default"](_reactDom2["default"].findDOMNode(this), (0, _objectAssign2["default"])({}, this.props));
  };

  ReactSwiper.prototype.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    if (this.props.rebuildOnUpdate && typeof this.swiper !== 'undefined') {
      this.swiper.destroy(true, true);
      this.swiper = new _swiper2["default"](_reactDom2["default"].findDOMNode(this), (0, _objectAssign2["default"])({}, nextProps));
    }
  };

  ReactSwiper.prototype.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
    return nextProps.children !== this.props.children;
  };

  ReactSwiper.prototype.componentDidUpdate = function componentDidUpdate() {
    var _this2 = this;
  ...
  ReactSwiper.prototype.componentWillUnmount = function componentWillUnmount() {
    if (typeof this.swiper !== 'undefined') this.swiper.destroy(true, true);
    delete this.swiper;
  };

  ReactSwiper.prototype.validateClass = function validateClass(className) {
    if (typeof className !== 'string') return '';
    return className.replace(/\.|#/g, ' ').trim();
  };

  ReactSwiper.prototype.renderScrollBar = function renderScrollBar() {
  ...
  ReactSwiper.prototype.renderPagination = function renderPagination() {
  ...
  ReactSwiper.prototype.renderNextButton = function renderNextButton() {
  ...
  ReactSwiper.prototype.renderPrevButton = function renderPrevButton() {
  ...
  ReactSwiper.prototype.renderParallax = function renderParallax() {
  ...
  ReactSwiper.prototype.renderContent = function renderContent(e) {
    if (!e) return null;
  ...
  ReactSwiper.prototype.render = function render() {
